...
/* ══ STATIC DATA ══ */
const ENAMES=['โกบลิน','โครงกระดูก','เงามืด','วิญญาณไฟ','บอส','โกเลม','ค้างคาว','วิเวิร์น','ชิลด์ไนท์','จอมมาร','หมอผี','นักรบเดือด','RB 001','แม่ฝูง'];
const EICONS=['👺','💀','👻','🔥','👹','🪨','🦇','🐉','🛡️','👁️','🧙','🧱','🤖','🕷️'];
...
const MTRIBE=['อสูร','ปีศาจ','วิญญาณ','วิญญาณ','ปีศาจ','หิน','ปีศาจ','มังกร','มนุษย์','ปีศาจ','วิญญาณ','มนุษย์','จักรกล','ปีศาจ'];
const MSTRENGTH=[

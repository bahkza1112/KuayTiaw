...
const MSPECIAL=[
  ...
  '✈️ บินได้ — Sniper, Archer, Thunder ยิงโดน | 📣 Shriek ทุก 7 วิ: ป้อมในรัศมี 3 ช่องยิงช้าลง 40% นาน 3 วิ — กำจัดให้เร็วก่อนที่ Shriek จะสะสม',
  '✈️ บินได้ — Sniper, Archer, Thunder ยิงโดน | 🌑 Shadow Veil: สลับ visible 4 วิ / invisible 2 วิ — ไม่รับดาเมจเลยขณะซ่อนตัว ต้องใช้ burst DPS ในช่วง visible'
];
...
const MWEAKNESS=[
  ...
  ['ฆ่าเร็วก่อน Shriek ครบรอบ','ป้อมธนู Archer ยิง air + rate สูง','ป้อมสายฟ้า Chain ถล่มหมู่'],
  ['ถล่ม burst DPS ช่วง visible 4 วิ','ป้อมสไนเปอร์ single-shot แรง','ป้อมธนูยิงรัวให้ได้สูงสุดในช่วง visible'],
];
/* 0=มอนธรรมดา 1=บอส */

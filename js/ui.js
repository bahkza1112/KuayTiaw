...
const PATCH_NOTES=[
  {ver:'1.9.10',date:'2026-06-13',title:'✨ หน้าเมนูหลักดูพรีเมียมขึ้น',notes:[
    'โลโก้ TOWER QUEST มีแอนิเมชันแสงเรืองรองเบาๆ',
    'ปุ่ม Story Mode และ ENDGAME มีเอฟเฟกต์เรืองแสง (glow) ให้ดูโดดเด่นขึ้น',
    'พื้นหลังหน้าเมนูมีมิติมากขึ้น (vignette + แสงไล่สีรอบโลโก้ + ดาวพื้นหลังเพิ่ม)',
    'แถบด้านบนและเมนูด้านล่างมีเอฟเฟกต์กระจกฝ้า (frosted glass)'
  ]},

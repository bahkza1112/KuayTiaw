...
const PATCH_NOTES=[
  {ver:'3.8.1',date:'2026-06-17',title:'🎯 ป้อมเวทมนตร์ & สไนเปอร์ ล็อกเป้าหมอผีก่อนเสมอ',notes:[
    'ป้อมเวทมนตร์และสไนเปอร์ตอนนี้ล็อกเป้าหมอผี (🧙) ก่อนศัตรูอื่นทันทีที่อยู่ในระยะ',

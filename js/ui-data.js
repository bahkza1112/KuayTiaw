...
const CUTSCENES = [
  ...
  { bg:'linear-gradient(160deg,#03060e,#060c24)',
    slides:[
      ...
      {speaker:'นักมายากล',icon:'❄️',title:'⚠️ Ice King — ราชาน้ำแข็ง!',
  ...
  { bg:'linear-gradient(160deg,#0a0515,#150c2e)',
    slides:[
      ...
      {speaker:'นักมายากล',icon:'🌀',title:'นาคาราช + แม่ฝูง — คอมโบอันตราย',
  ...
  { bg:'linear-gradient(160deg,#020810,#040e20,#000)',
    slides:[
      ...
      {speaker:'นักมายากล',icon:'🔮',title:'⚠️ ภัยคุกคามระดับโลก!',

...
const GAME_VERSION='3.25.16';
const PATCH_NOTES=[
  {ver:'3.25.16',date:'2026-07-07',title:'🔧 แก้บั๊กอัพสกิลป้อมซัพพอร์ตฟรีไม่จำกัด + มินิกันปรับใหม่',notes:[
    'แก้บั๊ก: ป้อมซัพพอร์ตกดอัพ "เพิ่มดาเมจบัฟ" ได้ฟรีไม่จำกัดโดยไม่ต้องรวมป้อมเพิ่มดาว (ตอนนี้แต้มสกิลถูกจำกัดตามดาวเหมือนป้อมอื่นแล้ว)',
    'ป้อมมินิกัน: เปลี่ยนกระสุนจากลูกธนูขนนก (ของเก่าที่หลงเหลือ) เป็นแสงสีเหลืองเล็กๆ ยาวรีแบบกระสุนจริง และกระสุนเร็วขึ้น 2 เท่า',
  ]},
  {ver:'3.25.15',date:'2026-07-07',title:'❄️ ป้อมน้ำแข็งยิงเป็นควันเย็น + ⚔️ ไอคอนบัฟซัพพอร์ต',notes:[
    'ป้อมน้ำแข็ง: เปลี่ยนกระสุนจากเกล็ดหิมะแข็งเป็นก้อนควันสีฟ้าลอยไปหาเป้า พร้อมควันเย็นคลุมตัวมอนตอนโดนตี ให้เห็นภาพว่าโดนหน่วงชัดขึ้น',
    'ไอคอนบัฟจากป้อมซัพพอร์ต: เปลี่ยนจากรูปหัวใจเป็นรูปดาบ ให้สื่อถึงบัฟดาเมจชัดเจนขึ้น',
  ]},
  {ver:'3.25.14',date:'2026-07-07',title:'🎯 กระสุนป้อมสไนเปอร์เร็วขึ้น 3 เท่า',notes:[
    'กระสุนป้อมสไนเปอร์ลอยไปหาศัตรูเร็วขึ้น 3 เท่า ลดความรู้สึกช้าหน่วงตอนยิงเป้าไกลๆ',
  ]},
  {ver:'3.25.13',date:'2026-07-06',title:'🔧 เอาแสงปากกระบอกป้อมออกทั้งหมด',notes:[
    'ลบเอฟเฟกต์แสงยิง (muzzle flash) ออกจากป้อมทุกชนิด ป้อมจะโชว์แค่ท่ายิง/แรงสะท้อนเวลายิงเท่านั้น',
  ]},
  {ver:'3.25.12',date:'2026-07-06',title:'💥 แสงยิงป้อมสไนเปอร์/สายฟ้าเข้าธีมมากขึ้น',notes:[
    'ป้อมสไนเปอร์: เปลี่ยนแสงยิงเป็นลำแสงคมชัดพุ่งตรงยาว + กากบาทแฟลชไฮเดอร์ แทนภาพระเบิดรอบทิศ ให้ความรู้สึกไรเฟิลแม่นยำ',
    'ป้อมสายฟ้า: เปลี่ยนแสงยิงเป็นสายฟ้าซิกแซกจริงพร้อมแขนงแยก แทนภาพระเบิดรอบทิศแบบเดียวกับป้อมอื่น ให้ดูเป็นไฟฟ้าจริง',
  ]},
  {ver:'3.25.11',date:'2026-07-06',title:'💥 แสงปากกระบอกป้อมมินิกันสมจริงขึ้น',notes:[
    'เปลี่ยนแสงยิงของป้อมมินิกันจากภาพระเบิดรอบทิศ (เหมือนป้อมอื่น) เป็นกรวยแสงพุ่งไปข้างหน้าตามแนวยิง เหมือนแสงปากกระบอกปืนจริง เข้ากับป้อมมากขึ้น',
  ]},
  {ver:'3.25.10',date:'2026-07-06',title:'🔫 ป้อมมินิกันมีเสียงลำกล้องหมุนหวี้ด',notes:[
    'เพิ่มเสียงมอเตอร์หวี้ดหมุนลำกล้องซ้อนใต้เสียงยิงป้อมมินิกัน ยิ่งยิงรัวต่อเนื่องยิ่งหวี้ดแรง/สูงขึ้น เข้ากับธีมมินิกันมากขึ้น',
  ]},
  {ver:'3.25.9',date:'2026-07-06',title:'⚡ ป้อมสายฟ้ายิงเป็นสายฟ้าจริง',notes:[
    'เปลี่ยนกระสุนป้อมสายฟ้าจากลูกกลมๆ เป็นสายฟ้าเส้นยาวลากจากป้อมถึงเป้าหมายจริงๆ ดูเท่และเข้ากับป้อมมากขึ้น',
  ]},
  {ver:'3.25.8',date:'2026-07-06',title:'🔊 ลดเสียงป้อมสายฟ้าลง',notes:[
    'ปรับเสียงยิงของป้อมสายฟ้าให้เบาลง ไม่กลบเสียงป้อมอื่น',
  ]},
  {ver:'3.25.7',date:'2026-07-06',title:'🎵 เพลงพื้นหลังสนุกขึ้น + เสียงกดปุ่ม',notes:[
    'เปลี่ยนเพลงพื้นหลังในเกมให้สนุกสนาน กระโดดโลดเต้นแบบเกมอาร์เคด (Mario-inspired)',
    'เพิ่มเสียงบลิปตอนกดปุ่มต่างๆ ทั่วเกม ให้ตอบสนองสนุกขึ้น',
  ]},
  {ver:'3.25.6',date:'2026-07-06',title:'🔒 อัปเดตความปลอดภัยเบื้องหลัง',notes:[
    'ปรับปรุงระบบยืนยันตัวตนของแอดมินให้ปลอดภัยขึ้น — ไม่มีผลกับผู้เล่นทั่วไป',
  ]},
  {ver:'3.25.5',date:'2026-07-06',title:'🔖 เพิ่มไอคอนเกม + ตัวอย่างพรีวิวตอนแชร์ลิงก์',notes:[
    'เพิ่ม favicon ของเกม (โลโก้ Tower Quest) ให้ขึ้นในแท็บเบราว์เซอร์',
    'แชร์ลิงก์เกมใน LINE/Facebook/Twitter ตอนนี้จะโชว์รูปภาพและคำอธิบายเกมแล้ว',
  ]},
  {ver:'3.25.4',date:'2026-07-04',title:'🎨 ป้อมสไนเปอร์/ซัพพอร์ตปรับสไตล์ให้เข้าชุด + มอนสเตอร์ไหวตอนวางเฉยๆ',notes:[
    'ป้อมสไนเปอร์และซัพพอร์ตทำภาพใหม่ทุกขั้นดาว ให้เข้าชุดสไตล์กับป้อมอื่นๆ มากขึ้น',
    'มอนสเตอร์ทุกตัวมีจุดเรืองแสง/ดวงตาสว่างวูบวาบเบาๆ ระหว่างเดิน เหมือนป้อมที่ทำไปก่อนหน้า',
  ]},
  {ver:'3.25.3',date:'2026-07-04',title:'⚖️ ปรับขนาดป้อม/มอนสเตอร์ให้พอดีขึ้น',notes:[
    'ป้อมทุกชนิดเล็กลงเล็กน้อยเพื่อไม่ให้ป้อมข้างเคียงทับกัน มองเห็นแต่ละป้อมชัดขึ้น',
    'มอนสเตอร์ทั่วไปเล็กลงเล็กน้อย ส่วนบอสทุกตัวยังคงขนาดใหญ่อลังการเหมือนเดิม',
  ]},

...
const PATCH_NOTES=[
  ...
  {ver:'3.24.11',date:'2026-06-29',title:'🌑 โมฆะ Rework — ราคา 80g, proc 20%→60%, +20%→+50%',notes:[
    ...
    'Void Mark bonus: +25% → +20% (ปกติ), +40% → +50% (อเวค)',
    'สาย 1 📡 Lv3: เจาะโล่ | สาย 2 ⚡ Lv3: ยิงรัว (ไม่เปลี่ยน)',
  ]},
  ...
  {ver:'3.24.9',date:'2026-06-29',title:'🔫 มินิกัน Rework — DMG 10, Rate 2.5/s, Awaken ×2',notes:[
    ...
    'Range 2.8 → 3.0 ช่อง',
    'Rate 1.8 → 2.5/s (ยิงถี่ขึ้นมาก)',
    'Awaken: อัตรายิง ×2 จากค่าปัจจุบัน (รวมโบนัสอัพสายแล้ว)',
    'สาย 1 📡 ระยะ Lv3: เจาะโล่ | สาย 2 ⚡ ความเร็ว Lv3: ยิงรัว',
  ]},
  {ver:'3.24.8',date:'2026-06-29',title:'💚 ซัพพอร์ต Rework — กันหยุด 20-50%, สาย Lv3 unlock',notes:[
    'กันหยุดป้อม ★1-4: 20/40/60/80% → 20/30/40/50% (อเวค 100%→50%)',
    'สาย 1 💪 เพิ่มดาเมจบัฟ (+10%/Lv) → Lv3: ปลดล็อกกันหยุด +30% เพิ่มเติม',
    'สาย 2 🛡️ กันหยุดป้อม (+5%/Lv) → Lv3: ปลดล็อกบัฟดาเมจ +30% เพิ่มเติม',
    'Awaken: กันหยุด 50% (ฐาน) + ออร่าบัฟแรงขึ้น',
  ]},
  ...
  {ver:'3.24.5',date:'2026-06-29',title:'❄️ น้ำแข็ง Rework — Slow แรงขึ้น + Awaken แช่แข็ง',notes:[
    ...
    'สาย 1 เปลี่ยนจาก ระยะ → ระยะเวลาสโล (Lv1=2วิ, Lv2=2.5วิ, Lv3=3วิ)',
    'ระยะคงที่ที่ 2.0 ช่อง ไม่ขึ้นตามอัพ',
    'Awaken: 35% แช่แข็ง 2วิ — ถ้าไม่ติด slow 70% ตามปกติ',
  ]},
  {ver:'3.24.4',date:'2026-06-29',title:'💣 ปืนใหญ่ ปรับ Rework — Splash ย้ายไปอยู่ใน Awaken',notes:[
    'ลดราคา 50 → 45 ทอง',
    'ลบ Splash พื้นฐาน 0.8 ช่อง ออก — ตอนนี้ยิงเป็นกระสุนเดี่ยว',
    'Awaken ปลด Splash 2.0 ช่อง (เดิม ×1.5 จาก base 0.8 = 1.2)',
    'ทำให้ปืนใหญ่ปกติใช้งานได้เอง Awaken จึงรู้สึกคุ้มค่าขึ้นมาก',
  ]},
  {ver:'3.24.3',date:'2026-06-29',title:'⚖️ ปรับ Balance ดาเมจตามดาว',notes:[
    'เปลี่ยน STAR_DMG_BONUS: [×1, ×1.5, ×2.1, ×3.0] → [×1, ×1.5, ×2, ×4]',
    '★3 ดาเมจเพิ่มขึ้นเล็กน้อย: ×2.1 → ×2.0 (เกือบเท่าเดิม)',
    '★4 ดาเมจพุ่งสูงขึ้นมาก: ×3.0 → ×4.0 (+33% จากเดิม)',
    'ทำให้การรวมป้อมถึง ★4 รู้สึกคุ้มค่ามากขึ้น',
  ]},
